...
import TestingLocalChatUI from "pages/chatpage/TestingLocalChatUI";
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/chatlocal/:id" element={<TestingLocalChatUI />} />
      <Route
        path="/testingchatlocaltesting/:id"
        element={<TestingLocalChatUI />}
      />
