...
export default function ProductDetailLocalPage() {
  ...
  return (
    ...
    >
      ...
      <Typography variant="body2">
        마감 기한 : ~ {dayjs(product?.deadline).format("YYYY.MM.DD HH:mm")}
      </Typography>
      ...
      >
        ...
        <Button variant="outlined" onClick={handleQOpen}>
          문의하기
        </Button>
      </Box>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={handleQClose}>확인</Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <PurchaseDialog product={product} productId={id} remain={remain} />
      </Box>
          ...
          <Box sx={{ overflow: "auto", height: "40vh" }}>
            {bids?.map((bid, index) => (
              <Box key={index}>
                ...
                >
                  <Typography variant="h6">{bid?.memberId}</Typography>
                ...
                <Typography variant="body2" align="right">
                  {dayjs(bid?.createdAt).format("YYYY.MM.DD HH:mm:ss")}
                </Typography>
                <hr />
              </Box>
            ))}
